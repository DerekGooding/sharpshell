...
public partial class TestShellForm : Form
{
    ...
    public TestShellForm()
    {
        ...
        //shellListView.OnShellItemAdded += new Apex.MVVM.CommandEventHandler(shellListView_OnShellItemAdded);
    ...
    private void shellTreeView_OnShellItemAdded(object sender, TreeViewEventArgs e)
    {
    ...
    //private void shellListView_OnShellItemAdded(object sender, Apex.Controls.SelectableItemsControl args)
    //{
...
#pragma warning restore 618
    ...
    /// </value>
    public SharpContextMenu TestContextMenu
    { get { return TestServer as SharpContextMenu; } }
    ...
    /// </value>
    public SharpIconHandler TestIconHandler
    { get { return TestServer as SharpIconHandler; } }
    ...
    /// </value>
    public SharpThumbnailHandler TestThumbnailHandler
    { get { return TestServer as SharpThumbnailHandler; } }
    ...
    /// </value>
    public SharpInfoTipHandler TestInfoTipHandler
    { get { return TestServer as SharpInfoTipHandler; } }

    /// <summary>
    /// Gets the test drop handler.
    /// </summary>
    public SharpDropHandler TestDropHandler
    { get { return TestServer as SharpDropHandler; } }
    ...
    /// </value>
    public SharpPreviewHandler TestPreviewHandler
    { get { return TestServer as SharpPreviewHandler; } }

    /// <summary>
    /// Gets the test icon overlay handler.
    /// </summary>
    public SharpIconOverlayHandler TestIconOverlayHandler
    { get { return TestServer as SharpIconOverlayHandler; } }
